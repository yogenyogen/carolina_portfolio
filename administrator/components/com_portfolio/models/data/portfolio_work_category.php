...
/**
 * Instance of D.B. table portfolio_work_category this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class portfolio_work_category extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return portfolio_work_category dbobject or false on failure.
     */
     ...
     *
     * @return boolean|portfolio_work_category Not false on success.
     */
     ...
     *
     * @return portfolio_work_category not false on success.
     */
