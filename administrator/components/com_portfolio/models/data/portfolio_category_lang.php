...
/**
 * Instance of D.B. table portfolio_category_lang this object
 * has the basic CRUD functions build-in, for
 * normalized databases tables.
 *
 * @author Gabriel Gonzalez Disla
 */
class portfolio_category_lang extends dbobject {
    ...
    */
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return portfolio_category_lang dbobject or false on failure.
     */
     ...
     *
     * @return boolean|portfolio_category_lang Not false on success.
     */
     ...
     *
     * @return portfolio_category_lang not false on success.
     */
